...
function validate_form(thisform) {
    with (thisform) {
        ...
        if (sel != null) {
            if (sel.options[sel.selectedIndex].value == "Nigeria" || sel.options[sel.selectedIndex].value == "Cameroon" || sel.options[sel.selectedIndex].value == "Uganda" || sel.options[sel.selectedIndex].value == "Nepal" || sel.options[sel.selectedIndex].value == "Ghana") {
