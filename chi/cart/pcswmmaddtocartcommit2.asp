...
<%
    ...
    If Len(PCSWMMSoftwareVersion) = 0 Then
        PCSWMMSoftwareVersion = Request.QueryString("Purchase")
        Select Case PCSWMMSoftwareVersion
            Case "Professional"  
                PCSWMMSoftwareVersion = "PCSWMM Professional" 
                PCSWMMNumLicenses = 1
            Case "2D"  
                PCSWMMSoftwareVersion = "PCSWMM Professional 2D" 
                PCSWMMNumLicenses = 1
            Case "Enterprise"  
                PCSWMMSoftwareVersion = "PCSWMM Enterprise" 
                PCSWMMNumLicenses = 3
            Case Else
